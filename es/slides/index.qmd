...
![](../../shared/images/SCALAR_VECTOR_MATRIZ_TENSOR.png){width="75%"}
...
![](../../shared/images/Vectores.png){.vector-full-image}

## Matrices {.matrix-image-slide}

<div class="matrix-image-container">

![](../../shared/images/Matrices.png)
...
![](../../shared/images/Dim_Tensores.png){fig-align="center" width="55%"}
...
![](../../shared/images/Broadcasting.png)

<div class="lab-button">[Abrir laboratorio 2.1 en Colab](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/01_scalars_vectors_matrices_tensors.ipynb)</div>



## 2.2 Multiplicación de Matrices y Vectores {.full-image-slide}

![](../../shared/images/Multi_Vect_matri.png)

<div class="lab-button">[Abrir laboratorio 2.2](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/02_multiplying_matrices_vectors.ipynb)</div>

## 2.3 Matrices identidad e inversa {.full-image-slide}

![](../../shared/images/Identidad_Inversa.png)

<div class="lab-button">[Abrir laboratorio 2.3](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/03_identity_inverse_matrices.ipynb)</div>

## 2.4 Dependencia lineal y span {.full-image-slide}

![](../../shared/images/Dependencia_Lineal.png)

<div class="lab-button">[Abrir laboratorio 2.4](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/04_linear_dependence_span.ipynb)</div>

## 2.5 Normas {.full-image-slide}

![](../../shared/images/Norms.png)

<div class="lab-button">[Abrir laboratorio 2.5](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/05_norms.ipynb)</div>

## 2.6 Tipos especiales de matrices y vectores {.full-image-slide}

![](../../shared/images/Tipos_Especiales_M_V.png)

<div class="lab-button">[Abrir laboratorio 2.6](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/06_special_matrices_vectors.ipynb)</div>

## 2.7 Descomposición en autovalores (Eigendecomposition) {.full-image-slide}

![](../../shared/images/Eigendecomposition.png)

<div class="lab-button">[Abrir laboratorio 2.7](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/07_eigendecomposition.ipynb)</div>

## 2.8 Descomposición en valores singulares (SVD) {.full-image-slide}

![](../../shared/images/SVD.png)

<div class="lab-button">[Abrir laboratorio 2.8](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/08_svd.ipynb)</div>

## 2.9 Pseudoinversa de Moore–Penrose {.full-image-slide}

![](../../shared/images/Moore_Penrose_Pseudoinverse.png)

<div class="lab-button">[Abrir laboratorio 2.9](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/09_pseudoinverse.ipynb)</div>

## 2.10 El Operador Traza (Trace Operator) {.full-image-slide}

![](../../shared/images/Trace_Operator.png)

<div class="lab-button">[Abrir laboratorio 2.10](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/10_trace_operator.ipynb)</div>

## 2.11 Determinante {.full-image-slide}
![](../../shared/images/Determinante.png)

<div class="lab-button">[Abrir laboratorio 2.11](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/11_determinant.ipynb)</div>

## 2.12 Ejemplo: Principal Components Analysis (PCA) {.full-image-slide}

![](../../shared/images/PCA.png)

<div class="lab-button">[Abrir laboratorio 2.12](https://colab.research.google.com/github/Laverde97/linear-algebra-deep-learning/blob/main/es/exercises/12_pca.ipynb)</div>
...
- Goodfellow, I., Bengio, Y. & Courville, A. **Deep Learning**, Chapter 2: Linear Algebra. MIT Press [@goodfellow2016]. https://www.deeplearningbook.org/contents/linear_algebra.html
...
- MNIST via TensorFlow/Keras [@lecun1998].
- IMDB Reviews via TensorFlow/Keras [@maas2011].
- ImageNet-v2 documentation via TensorFlow Datasets [@recht2019]; for the live class the notebook uses a lightweight ImageNet-format demonstration and leaves ImageNet-v2 as optional due to download size.
